...
void main() {
  ...
  setUp(() {
    ...
    dataSource = TvRemoteDataSourceImpl(client: mockCoreHttpClient);
  });
  ...
  group('get Now Playing Tv', () {
    ...
    test('should return list of tv model when the response code is 200',
        () async {
      when(mockCoreHttpClient.get(Uri.parse('$baseUrl/tv/airing_today?$apiKey')))
  ...
  group('get Popular Tv', () {
    ...
    test('should return list of tv when response is success (200)', () async {
      when(mockCoreHttpClient.get(Uri.parse('$baseUrl/tv/popular?$apiKey')))
          .thenAnswer((_) async => http.Response(
  ...
  group('get Top Rated Tv', () {
    ...
    test('should return list of tv when response code is 200 ', () async {
      when(mockCoreHttpClient.get(Uri.parse('$baseUrl/tv/top_rated?$apiKey')))
          .thenAnswer((_) async => http.Response(
  ...
  group('get TV detail', () {
    ...
    test('should return tv detail when the response code is 200', () async {
      when(mockCoreHttpClient.get(Uri.parse('$baseUrl/tv/$id?$apiKey'))).thenAnswer(
    ...
    test('should throw Server Exception when the response code is 404 or other',
        () async {
      when(mockCoreHttpClient.get(Uri.parse('$baseUrl/tv/$id?$apiKey')))
          .thenAnswer((_) async => http.Response('Not Found', 404));
