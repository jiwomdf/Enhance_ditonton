...
void main() {
  ...
  late MockCoreHttpClient mockCoreHttpClient;

  setUp(() {
    mockCoreHttpClient = MockCoreHttpClient();
    dataSource = MovieRemoteDataSourceImpl(client: mockCoreHttpClient);
  });
  ...
  group('get Now Playing Movies', () {
    ...
    test('should return list of Movie Model when the response code is 200',
        () async {
      // arrange
      when(mockCoreHttpClient.get(Uri.parse('$baseUrl/movie/now_playing?$apiKey')))
          .thenAnswer((_) async =>
  ...
  group('get Popular Movies', () {
    ...
    test('should return list of movies when response is success (200)',
        () async {
      // arrange
      when(mockCoreHttpClient.get(Uri.parse('$baseUrl/movie/popular?$apiKey')))
          .thenAnswer((_) async =>
  ...
  group('get Top Rated Movies', () {
    ...
    test('should return list of movies when response code is 200 ', () async {
      // arrange
      when(mockCoreHttpClient.get(Uri.parse('$baseUrl/movie/top_rated?$apiKey')))
          .thenAnswer((_) async =>
  ...
  group('get page detail', () {
    const tId = 1;
    final tMovieDetail = MovieDetailResponse.fromJson(
        json.decode(readJson('dummy_data/movie_detail.json')));

    test('should return page detail when the response code is 200', () async {
      // arrange
      when(mockCoreHttpClient.get(Uri.parse('$baseUrl/movie/$tId?$apiKey')))
          .thenAnswer((_) async =>
  ...
  group('get page recommendations', () {
    final tMovieList = MovieResponse.fromJson(
